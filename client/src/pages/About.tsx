      ...
      <main className="pt-32 pb-24">
        ...
        <div className="container mx-auto px-4 md:px-6 mb-24">
          ...
          <p className="text-lg md:text-xl text-foreground/80 mb-8 max-w-3xl mx-auto leading-relaxed">
            KREATIVE ROBOTICS was founded with a single mission: to democratize access to cutting-edge technology education. We believe that robotics are not just for scientists in labs, but for anyone with curiosity and imagination.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="glass-card p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-foreground tracking-wider leading-relaxed">{item.title}</h3>
                  <p className="text-foreground/80 tracking-wide leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
