    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="py-16 md:py-24 bg-gray-900 text-white overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 md:mb-16 items-center">
            ...
            <div className="flex justify-center md:justify-end">
              <Link href="/program/overview">
                <button className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-primary text-primary flex items-center justify-center text-[10px] md:text-xs font-bold uppercase hover:bg-primary hover:text-white transition-all active:scale-95 shrink-0">
                  More Info
                </button>
              </Link>
            </div>
